...
require_relative 'mtg_scraper/flip_card'
require_relative 'mtg_scraper/flip_card/extract'
require_relative 'mtg_scraper/flip_card/transform'
require_relative 'mtg_scraper/flip_card/load'
